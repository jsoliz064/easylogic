...
<input class="boton-personalizado-2" type="button" onclick="history.back()" name="boton-personalizado-2" value="volver" />
<div class="w3-bar">
<center>
<div class="pagination">
  <a href="#">❮</a>
  <a class="active" href="#" class="w3-button">1</a>
